...
const projects = [
  {
    ...
    description: `An e-commerce store with carousel, countdown timer for deal, products' filters and sorting, search, reviews, cart and checkout with 3 different payment methods. Also an admin dashboard with stats and the ability to handle the products, orders and users. Username: admin@example.com | Password: 123456`,
    stack: [
      { name: "HTML 5" },
      { name: "Tailwind.CSS" },
      { name: "Typescript" },
    ...
    live: "https://prostore-ecommerce-site.vercel.app",
    github: "https://github.com/giamanpanos/prostore",
  },
  {
    num: "02",
    category: "frontend",
    ...
    live: "https://netflix-clone-website-new.vercel.app",
    github: "https://github.com/giamanpanos/netflix",
  },
  {
    num: "03",
    category: "frontend",
